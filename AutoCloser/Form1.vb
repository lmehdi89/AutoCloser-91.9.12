...
y:
        ...
        Try
            ...
            If Not Me.NotifyIcon1.Visible Then
                ...
                Else
                    Me.Hide()
                End If
                CheckBox1.Checked = GetSetting("Atcr", "Startup", "true", True)
                ComboBox1.Text = GetSetting("Atcr", "Startup", "name", "sgmain")
                NumericUpDown1.Value = GetSetting("Atcr", "Startup", "time", 180)
                SaveSetting("Atcr", "Startup", "first", 1)
                If GetSetting("Atcr", "Startup", "Unin", "0") = "1" Then
                    Button3.Enabled = False
                End If
                SaveSetting("Atcr", "Startup", "text", "بسته می شود برای جلوگیری از این اقدام برروی صفحه اصلی برنامه کلیک کنید")
                q = GetSetting("Atcr", "Startup", "q", True)
                t = NumericUpDown1.Value
            End If
        Catch ex As Exception
            MsgBox(ex.ToString, , "خطای")
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        re = Registry.LocalMachine.OpenSubKey("SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall", True)
        re.DeleteSubKey("{927BF06D-DE19-4159-AC66-EDB924A6015D}", RegistryKeyPermissionCheck.ReadWriteSubTree)
        re.Close()
        SaveSetting("Atcr", "Startup", "Unin", 1)
        Button3.Enabled = False
        MsgBox("غیر فعال شد")
    End Sub
End Class
